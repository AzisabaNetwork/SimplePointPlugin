...
public class SPPTTabCompleter implements TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        // 1. サブコマンドの補完
        if (args.length == 1) {
            List<String> subs = Arrays.asList("leave", "finishvsmode", "create", "teamcreate", "join", "setpoint", "info","manual", "rewardgui", "multiplier", "vsteam", "teaminfo", "teamjoingui", "setjoingui", "member", "toggle", "setpoint_value", "help");
