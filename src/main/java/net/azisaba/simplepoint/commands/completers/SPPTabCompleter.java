...
public class SPPTabCompleter implements TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        // 1. サブコマンドの補完: /spp <ここ>
        if (args.length == 1) {
            List<String> subCommands = Arrays.asList("adminranking","userrank","togglereward","togglefunction","create", "add", "remove", "set", "score", "rewardgui", "setreq", "ranking", "toggleranking", "reload", "help");
        ...
        // 2. 第2引数の補完: /spp <sub> <ここ>
            ...
            // IDが必要なコマンド群
            List<String> needsIdAsSecond = Arrays.asList("adminranking","userrank","togglefunction","add", "remove", "set", "score", "rewardgui", "setreq", "ranking", "togglereward","toggleranking");
